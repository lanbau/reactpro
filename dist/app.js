...
/***/ function(module, exports, __webpack_require__) {
	...
	var _componentsSearchBox = __webpack_require__(159);
...
/***/ function(module, exports) {
	...
	exports['default'] = SearchBox = React.createClass({
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      { className: 'searchbox' },
	      '// input box',
	      React.createElement('input', { onChange: this.whenUserTypes, type: 'text',
	  ...
	  getSearchingForDom: function getSearchingForDom() {
	  ...
	  whenUserTypes: function whenUserTypes(e) {
